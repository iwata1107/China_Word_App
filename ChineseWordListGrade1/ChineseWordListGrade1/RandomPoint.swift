...
class MakeRandomInt: ObservableObject {
    
    @Published var checkData = UserDefaults.standard.array(forKey:"") as? [Int] ?? [] //何番目ができたか
    @Published var percentData = UserDefaults.standard.array(forKey: "a") as? [Int] ?? []  //何個できたか
    
    @Published var chineseCount = ["爱","八","爸爸","杯子","北京","本","不","不客气","菜","茶","吃","出租车","打电话","大","的"
